...
(custom-set-variables
 ...
 '(org-capture-templates
   '(("t" "Todo" entry
      (file+olp+datetree "/home/yiwen/Oympt/agenda.org" "GTDs")
...
" :time-prompt t)
     ("s" "Code Snippets" table-line
      (file+olp "/home/yiwen/Oympt/log.org" "Code Snippets")
      "| %U | %^{LANG} | %^{Description} | %^{Links} |")
     ("c" "Contacts" table-line
      (file+olp "/home/yiwen/Oympt/log.org" "Contacts")
      "| %U | %^{Name} | %^{Phone}| %^{E-mail} |")
     ("l" "Log Records" entry
      (file+olp "/home/yiwen/Oympt/log.org" "Log Records")
      "* %U %^{Message} %^g
%?
")))
