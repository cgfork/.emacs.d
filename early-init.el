...
(defcustom yw-http-proxy (yw-get-shell-variable "HTTP_PROXY" yw-shell-executable)
  "Define the http or https proxy."
  :type 'string
  :group 'ywg)

(defcustom yw-https-proxy (yw-get-shell-variable "HTTPS_PROXY" yw-shell-executable)
  "Define the http or https proxy."
  :type 'string
  :group 'ywg)
